	  		...
	  		<div className="container">
		  		...
		  		<section className="row page-title">
		  			...
		  			<div className="col-8">
		  				...
		  				{post.portfolioCategories.nodes.map((portfolioCategory, i) => (

				  					<li key={i}>{portfolioCategory.name}</li>

					  		))}

		  					{post.portfolioTags.nodes.map((portfolioTag, i) => (

				  					<li key={i}>{portfolioTag.name}</li>
	  		...
	  		<section id="portfolio-body" className="container">
	  			...
	  			<div className={((active === 'overview') ? 'row active' : 'row' )}>
		  			...
		  			<div className="wrapper">
		  				...
		  				{post.portfolioData.attribution ? ( 

			  				<div className="wrap attribution">

			  					<p className="title">Heads up!</p>

			  					<div dangerouslySetInnerHTML={{ __html: post.portfolioData.attribution}}></div>
