  		...
  		<LayoutStandard>
	  		...
	  		<section id="homepage-hero" className="row">
	  			...
	  			<div className="col-7 text-content">
	  				...
	  				<p style={{maxWidth: '525px'}}>Customer-centric design to help SaaS companies <span class="underline">land more trials and minimize churn</span>, and eCommerce stores <span class="underline">generate more sales</span>.</p>
