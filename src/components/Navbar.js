          ...
          <div className="row">
            ...
            <div className="col-6 right">
              ...
              <ul className='desktopMenu'> 
                ...
                <li className="schedule"><PopupButton url="https://calendly.com/kbs-marc/hello" text="Let's Talk" rootElement={typeof window !== "undefined" ? document.getElementById("__gatsby") : null } className="accent button"></PopupButton></li>
          ...
          <div className="row">
           ...
           <div className="col-12">
              ...
              <ul open={open} className= {'mobileMenu ' + (open ? 'open' : 'closed')}> 
                ...
                {/* <li className="schedule"><PopupButton url="https://calendly.com/kbs-marc/hello" text="Let's Talk"></PopupButton></li> */}
