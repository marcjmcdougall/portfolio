    ...
    <div class="container">
        ...
        <section id="pricing-options" class="pricing-options padded">
            ...
            <div class="pricing-options__option pricing-options__option--featured">
                <svg class="pricing-options__option__icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
        ...
        <div class="bg--gray padded rounded row vcenter margin-top--lg margin-bottom--lg">
            <div class="col-7">
                <h2 class="h3 strip--mt newsletter-opt-in__title">Rather chat first?</h2>  
                    ...
                    <div class="button-wrap" x-data>
                        <div class="glimmer-container glimmer-container--light">
                            ...
                            <a href="#" 
                                ...
                                class="btn btn--secondary">
                                    Book Discovery Call
                                    <span class="keybind keybind--light">
