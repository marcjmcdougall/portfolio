<x-base 
    title="Marc McDougall – Design clean software interfaces in minutes"
        ...
        <div class="row vcenter resource-hero">
            <div class="col-7">
                <div class="resource-hero__text">
                    ...
                    <h1 class="resource-hero__title text--hero">Design clean interfaces in <span class="colorize underline">minutes.</span></h1>
                    <p class="body--large resource-hero__body">The Functional design system will help you ship faster, better software interfaces.</p>
