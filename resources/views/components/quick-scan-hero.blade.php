<section class="quick-scan-hero">
    <div class="row">
        <div class="quick-scan-hero__text col-7">
            <h1 class="resource-hero__title text--hero">Is your website optimized for <span class="colorize underline has-animation">conversions?</span></h1>
            <p class="body--large">Scan your landing page for hidden conversion-rate optimization opportunuties.</p>
            <x-quick-scan-form :quickScanEnabled="$quickScanEnabled"></x-quick-scan-form>
        </div>
